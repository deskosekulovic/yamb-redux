...
import { getData, toggleSelectDice, handleMouseOver, handleMouseOut, resetGame, rollDice, handleInput } from '../actions';
...
class Main extends Component {
    ...
    handleInput(e){
        const { dice, rollCounter, najavljeno, numberOfDice, onHandleInput } = this.props;
    ...
    render() {
        const { numberOfDice, columnsToAdd, numberOfFields, numberOfColumns, dice, rollCounter, selected, fields, permission, inputCount, najavljeno } = this.props;
        ...
        return (
            <StyledApp>
                <Game>
                    <Navigation>
                        <Span onClick={()=>this.props.onResetGame(numberOfDice)}><b>Nova igra</b></Span>
                    ...
                    />
                    <Button
                        rollDice={()=>this.props.rollDice(selected, dice, rollCounter, inputCount, najavljeno, numberOfDice, numberOfFields, this.najavaAndRucno)}
                        rollCounter={rollCounter}
